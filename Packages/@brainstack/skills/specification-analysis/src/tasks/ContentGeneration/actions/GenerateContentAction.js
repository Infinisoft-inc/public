...
class GenerateContentAction extends Action {
  constructor(apiKey) {
    super();
...
module.exports = GenerateContentAction;

const generateContentAction = new GenerateContentAction(APIKEY);
...
const main = async () => {
  async function processUserMessage() {
    ...
    try {
      const output = await generateContentAction.run(userMessage);
