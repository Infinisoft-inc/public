...
describe('inject', () => {
    let container;
    beforeEach(() => {
        container = new implementation_1.Container(); // Create a new Container instance before each test
    });
    ...
    it('should throw an error if a dependency is not registered', () => {
        ...
        ServiceB = __decorate([
            __param(0, implementation_1.Inject),
    ...
    it('should resolve dependencies using the Inject decorator', () => {
        ...
        Serv = __decorate([
            (0, implementation_1.Service)(container) // Pass the container to the decorator
        ], Serv);
    ...
    it('should allow multiple instances of different classes', () => {
        ...
        ServiceA = __decorate([
            (0, implementation_1.Service)(container) // Pass the container instance
        ], ServiceA);
        let ServiceB = class ServiceB {
            getInfo() {
                return 'Service B';
        ...
        Consumer = __decorate([
            __param(0, implementation_1.Inject),
            __param(1, implementation_1.Inject),
            __metadata("design:paramtypes", [ServiceA,
                ServiceB])
        ], Consumer);
    ...
    it('should handle optional container in Service decorator', () => {
        ...
        ModuleScopedService = __decorate([
            (0, implementation_1.Service)() // Uses default container for moduleAId
        ], ModuleScopedService);
        ...
        AnotherModuleScopedService = __decorate([
            (0, implementation_1.Service)() // Uses default container for moduleBId (different than moduleAId)
        ...
        const anotherContainer = new implementation_1.Container(); // testing different container now
        let ServiceA = class ServiceA {
            getValue() {
        ...
        ServiceA = __decorate([
            (0, implementation_1.Service)(anotherContainer)
        ], ServiceA);
    ...
    it('should return registered service identifiers', () => {
        ...
        ServiceA = __decorate([
            (0, implementation_1.Service)(container)
        ], ServiceA);
